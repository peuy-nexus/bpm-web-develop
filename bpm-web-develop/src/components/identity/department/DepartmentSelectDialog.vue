<template>
  <el-dialog :title="title" :visible.sync="visible" width="900px" class="el-dialog__height-max">
    <div class="department-select-dialog">
      <div class="department-select-dialog__left">
        <div class="department-select-dialog__left-filter">
          <el-input
      ...
      <div class="department-select-dialog__right">
...
<script lang="ts" src="./DepartmentSelectDialog.ts"></script>
