<template>
  <el-dialog :title="title" :visible.sync="visible" width="900px" class="el-dialog__height-max">
    <div class="user-select-dialog">
      <div class="user-select-dialog__left">
        <div class="user-select-dialog__left-filter">
          <el-input
      ...
      <div class="user-select-dialog__right">
...
<script lang="ts" src="./UserSelectDialog.ts"></script>
<style lang="scss">
.user-select-dialog {
  display: flex;
  overflow: hidden;
