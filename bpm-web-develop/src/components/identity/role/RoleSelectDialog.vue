<template>
  <el-dialog :title="title" :visible.sync="visible" width="900px" class="el-dialog__height-max">
    <div class="role-select-dialog">
      <div class="role-select-dialog__left">
        <div class="role-select-dialog__left-filter">
          <el-input
      ...
      <div class="role-select-dialog__right">
...
<script lang="ts" src="./RoleSelectDialog.ts"></script>
