<template>
  <el-dialog :title="title" :visible.sync="visible" width="900px" class="el-dialog__height-max">
    <div class="identity-select-dialog">
      <div class="identity-select-dialog__left">
        <div class="identity-select-dialog__left-filter">
          <el-input
      ...
      <div class="identity-select-dialog__right">
...
<script lang="ts" src="./IdentitySelectDialog.ts"></script>
<style lang="scss" scoped>
.identity-select-dialog {
  display: flex;
  overflow: hidden;
  height: 100%;
